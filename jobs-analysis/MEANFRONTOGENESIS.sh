...
#SBATCH --time=2:00:00
#SBATCH --job-name=ppMEANFRONTOGENESIS
#SBATCH --output=../scratch/logs/ppMEANFRONTOGENESIS.txt
...
julia -t 40 -- src-analysis/post-process.jl $SIM_OUTPUT_FOLDER MEANFRONTOGENESIS $RAM
