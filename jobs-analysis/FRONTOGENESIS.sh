...
#SBATCH --time=4:30:00
#SBATCH --job-name=ppFRONTOGENESIS
#SBATCH --output=../scratch/logs/ppFRONTOGENESIS.txt
...
julia -t 40 -- src-analysis/post-process.jl $SIM_OUTPUT_FOLDER FRONTOGENESIS $RAM
