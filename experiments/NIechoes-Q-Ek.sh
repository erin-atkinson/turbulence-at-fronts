...
#SBATCH --job-name=NIechoes-Q-Ek
#SBATCH --output=../scratch/logs/NIechoes-Q-Ek.txt
...
julia -t 8 -- src-fronts/simulation.jl ../scratch/Project/NIechoes-Q-Ek 0 "1e-4" 100 1024 512 128 "0.8" "0.0" "0" "0.001" "10" "2" "1" 500000