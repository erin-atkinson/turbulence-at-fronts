...
#SBATCH --job-name=NIechoes
#SBATCH --output=../scratch/logs/NIechoes.txt
...
julia -t 8 -- src-fronts/simulation.jl ../scratch/Project/NIechoes 0 "1e-4" 100 1024 512 128 "0.8" "0.0" "0" "0" "10" "0" "0.1" 500000