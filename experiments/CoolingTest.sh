...
#SBATCH --job-name=CoolingTest
#SBATCH --output=../scratch/logs/CoolingTest.txt
...
julia -t 8 -- src-fronts/simulation.jl ../scratch/Project/NIechoes 0 "1e-4" 100 1024 256 128 "0.3" "2.0" "0" "0" "10" "0" "0.1" 500000